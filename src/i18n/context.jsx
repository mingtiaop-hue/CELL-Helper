...
const translations = {
  zh: {
    app: { title: "GOOOOOD's Lab", subtitle: 'Sichuan Univ · BME · 2026' },
    nav: {
      ...
      plateLayout: '孔板排布', dataFormat: '数据处理',
    },
    home: { badge: '四川大学 · 生物医学工程', desc: '细胞实验室效率工具 · 从种板计算到 SOP 规范，一站式搞定', built: 'Built with Claude Code' },
  ...
  en: {
    ...
    nav: {
      ...
      plateLayout: 'Plate Layout', dataFormat: 'Data Format',
    },
    home: { badge: 'Sichuan University · BME', desc: 'Cell lab productivity tool — from seeding math to SOP standards, all in one place', built: 'Built with Claude Code' },
